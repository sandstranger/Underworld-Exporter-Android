...
public class Cutscene_Intro : Cuts {
	...
	public override void Awake()
    {
        ...
        AudioClipName[0] = GameModel.CurrentModel.BasePath + "SOUND" + sep + "/26.VOC";//1.8s


        //for 3 nights each attem=27
        AudioTimes[1] = AudioTimes[0] + 1.8f;
        AudioClipName[1] = GameModel.CurrentModel.BasePath + "SOUND" + sep + "27.VOC"; //7.3s

        //deja vu.=28
        AudioTimes[2] = AudioTimes[1] + 7.4f;//9.1f;
        AudioClipName[2] = GameModel.CurrentModel.BasePath + "SOUND" + sep + "28.VOC";//3.5s

        //Treachery & doom=23
        //AudioTimes[3]=18.0f;
        AudioTimes[3] = ImageTimes[2];
        AudioClipName[3] = GameModel.CurrentModel.BasePath + "SOUND" + sep + "23.VOC";//2.6s

        //My brother=24
        //AudioTimes[4]=21.0f;
        AudioTimes[4] = ImageTimes[3] + 1f;
        AudioClipName[4] = GameModel.CurrentModel.BasePath + "SOUND" + sep + "24.VOC";//3.6s

        //Brit in peril=25
        //AudioTimes[5]=27.0f;
        AudioTimes[5] = ImageTimes[5];
        AudioClipName[5] = GameModel.CurrentModel.BasePath + "SOUND" + sep + "25.VOC";//2.7s

        //sure that the ghost=30
        //AudioTimes[6]=30.0f;
        AudioTimes[6] = ImageTimes[6];
        AudioClipName[6] = GameModel.CurrentModel.BasePath + "SOUND" + sep + "30.VOC";//4.4s

        //scream=31
        AudioTimes[7] = ImageTimes[6] + 4.5f;
        AudioClipName[7] = GameModel.CurrentModel.BasePath + "SOUND" + sep + "31.VOC";//1.2s

        //a visitor=37
        AudioTimes[8] = ImageTimes[7];//42.0f;
        AudioClipName[8] = GameModel.CurrentModel.BasePath + "SOUND" + sep + "37.VOC";//2.9

        //were he not dead=38
        AudioTimes[9] = AudioTimes[8] + 2.9f;
        AudioClipName[9] = GameModel.CurrentModel.BasePath + "SOUND" + sep + "38.VOC";//3.2s

        //no matter hounds from the scent=39
        AudioTimes[10] = AudioTimes[9] + 3.2f;//48.1f;
        AudioClipName[10] = GameModel.CurrentModel.BasePath + "SOUND" + sep + "39.VOC";//3.5s

        //below a creature=32
        AudioTimes[11] = AudioTimes[10] + 4.0f;
        AudioClipName[11] = GameModel.CurrentModel.BasePath + "SOUND" + sep + "32.VOC";//5.3s

        //what has thou done=12
        AudioTimes[12] = ImageTimes[8];//66.0f;
        AudioClipName[12] = GameModel.CurrentModel.BasePath + "SOUND" + sep + "12.VOC";//2.5s

        //dropped to below=13
        AudioTimes[13] = AudioTimes[12] + 2.5f;//72.0f;
        AudioClipName[13] = GameModel.CurrentModel.BasePath + "SOUND" + sep + "13.VOC";//2.2s

        //he'll nay escape=14
        AudioTimes[14] = AudioTimes[13] + 2.2f;//78.0f;
        AudioClipName[14] = GameModel.CurrentModel.BasePath + "SOUND" + sep + "14.VOC";//3.5s

        //several tense hours=33
        AudioTimes[15] = ImageTimes[9];//84.0f;
        AudioClipName[15] = GameModel.CurrentModel.BasePath + "SOUND" + sep + "33.VOC";//3.135

        //ignoring you=34
        AudioTimes[16] = ImageTimes[10];//AudioTimes[15] + 3.2f;//AudioTimes[15]90.0f;
        AudioClipName[16] = GameModel.CurrentModel.BasePath + "SOUND" + sep + "34.VOC";//2.4s

        //what news colwyn	=00
        AudioTimes[17] = ImageTimes[11];// AudioTimes[16] + 2.5f;//96.0f;
        AudioClipName[17] = GameModel.CurrentModel.BasePath + "SOUND" + sep + "00.VOC";//1.7s

        //forgive us=15
        AudioTimes[18] = ImageTimes[12];//102.0f;
        AudioClipName[18] = GameModel.CurrentModel.BasePath + "SOUND" + sep + "15.VOC";//1.1s

        //the foul creature escaped=65
        AudioTimes[19] = AudioTimes[18] + 1.3f;//108.0f;
        AudioClipName[19] = GameModel.CurrentModel.BasePath + "SOUND" + sep + "65.VOC";//1.4s

        //a score gave chase=16
        AudioTimes[20] = AudioTimes[19] + 1.4f;//114.0f;
        AudioClipName[20] = GameModel.CurrentModel.BasePath + "SOUND" + sep + "16.VOC";//4s

        //we were attacked=17
        AudioTimes[21] = AudioTimes[20] + 4f; ;//120.0f;
        AudioClipName[21] = GameModel.CurrentModel.BasePath + "SOUND" + sep + "17.VOC";//2.4s

        //only 3 survied=18
        AudioTimes[22] = AudioTimes[21] + 2.4f; ;//126.0f;
        AudioClipName[22] = GameModel.CurrentModel.BasePath + "SOUND" + sep + "18.VOC";//1.4s

        //I see=50
        AudioTimes[23] = ImageTimes[13] + 1.0f;//132.0f;
        AudioClipName[23] = GameModel.CurrentModel.BasePath + "SOUND" + sep + "50.VOC";//1s

        //baron throws his eyes upon=35
        AudioTimes[24] = ImageTimes[14];//138.0f;
        AudioClipName[24] = GameModel.CurrentModel.BasePath + "SOUND" + sep + "35.VOC";//2.3s

        //i was warned.=01
        AudioTimes[25] = ImageTimes[15];//144.0f;
        AudioClipName[25] = GameModel.CurrentModel.BasePath + "SOUND" + sep + "01.VOC";//2.1s

        //last fortnight=02
        AudioTimes[26] = AudioTimes[25] + 2.1f;//150.0f;
        AudioClipName[26] = GameModel.CurrentModel.BasePath + "SOUND" + sep + "02.VOC";//5.3s

        //guard thy daughter=03
        AudioTimes[27] = AudioTimes[26] + 5.3f;//156.0f;
        AudioClipName[27] = GameModel.CurrentModel.BasePath + "SOUND" + sep + "03.VOC";//6.2s

        //I posted guards=04
        AudioTimes[28] = AudioTimes[27] + 6.4f;//162.0f;
        AudioClipName[28] = GameModel.CurrentModel.BasePath + "SOUND" + sep + "04.VOC";//4.2s		

        //they say=05
        AudioTimes[29] = AudioTimes[28] + 4.3f;//168.0f;
        AudioClipName[29] = GameModel.CurrentModel.BasePath + "SOUND" + sep + "05.VOC";//4.5s

        //you explain=36
        AudioTimes[30] = ImageTimes[16];//174.0f;
        AudioClipName[30] = GameModel.CurrentModel.BasePath + "SOUND" + sep + "36.VOC";//2.9s

        //whether you speak truth or falsehood=06
        AudioTimes[31] = ImageTimes[17];//180.0f;
        AudioClipName[31] = GameModel.CurrentModel.BasePath + "SOUND" + sep + "06.VOC";//3.9s

        //stories tell=07
        AudioTimes[32] = AudioTimes[31] + 4f;//186.0f;
        AudioClipName[32] = GameModel.CurrentModel.BasePath + "SOUND" + sep + "07.VOC";//5.4s

        //if thou art truely the avatar=08
        AudioTimes[33] = AudioTimes[32] + 5.5f; ;//192.0f;
        AudioClipName[33] = GameModel.CurrentModel.BasePath + "SOUND" + sep + "08.VOC";//4.3s

        //none here can survive=58
        AudioTimes[34] = AudioTimes[33] + 4.3f;//198.0f;
        AudioClipName[34] = GameModel.CurrentModel.BasePath + "SOUND" + sep + "58.VOC";//3.8s

        //my mind is set=09
        AudioTimes[35] = AudioTimes[34] + 4f;//204.0f;
        AudioClipName[35] = GameModel.CurrentModel.BasePath + "SOUND" + sep + "09.VOC";//3.9s

        //return here with my daughter=10
        AudioTimes[36] = AudioTimes[35] + 4f;//210.0f;
        AudioClipName[36] = GameModel.CurrentModel.BasePath + "SOUND" + sep + "10.VOC";//3.9s

        //if thou dost not return=11
        AudioTimes[37] = AudioTimes[36] + 5.8f;//216.0f;
        AudioClipName[37] = GameModel.CurrentModel.BasePath + "SOUND" + sep + "11.VOC";//5.6s

        //this be the foul pits=19
        AudioTimes[38] = ImageTimes[21];
        AudioClipName[38] = GameModel.CurrentModel.BasePath + "SOUND" + sep + "19.VOC";//4.9s

        //i will shut they in.=20
        AudioTimes[39] = AudioTimes[38] + 4.8f;//228.0f;
        AudioClipName[39] = GameModel.CurrentModel.BasePath + "SOUND" + sep + "20.VOC";//4.6s

        //other wise shut forever=22
        AudioTimes[40] = AudioTimes[39] + 3f;//234.0f;
        AudioClipName[40] = GameModel.CurrentModel.BasePath + "SOUND" + sep + "22.VOC";//2.7s
